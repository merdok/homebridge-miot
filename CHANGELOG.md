...
## [Unreleased]
### Added
- Add optional localization for automatically generated MIoT and HomeKit service display names through `nameLanguage`.
...
- Added support for xiaomi.kettle.v20 (Xiaomi Mi Smart Kettle) kettle Thanks @zloirog
