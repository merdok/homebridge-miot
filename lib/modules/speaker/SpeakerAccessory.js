...
class SpeakerAccessory extends BaseAccessory {
  ...
  initAccessories(name, uuid) {
    return [new Accessory(name, uuid, this.api.hap.Categories.SPEAKER)];
  }
  ...
  setupMainAccessoryService() {
    const volumeServiceName = this.getName() + ' Volume';
    this.volumeService = new Service.Lightbulb(this.sanitizeName(volumeServiceName), 'volumeService');
    this.setServiceConfiguredName(this.volumeService, volumeServiceName);
