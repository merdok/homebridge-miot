...
class DiffuserAccessory extends BaseAccessory {
  ...
  setupAdditionalAccessoryServices() {
    ...
    if (this.getDevice().supportsAutoFragrance()) {
      this.addPropWrapper('Auto Fragrance', this.getDevice().autoFragranceProp(), this.getDevice().onProp(), null, null, null);
    }

    if (this.getDevice().supportsAutoLight()) {
      this.addPropWrapper('Auto Light', this.getDevice().autoLightProp(), this.getDevice().onProp(), null, null, null);
    }

    if (this.getDevice().supportsLightAutoOff()) {
      this.addPropWrapper('Light Auto Off', this.getDevice().lightAutoOffProp(), this.getDevice().onProp(), null, null, null);
    }
