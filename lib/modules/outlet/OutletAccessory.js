...
class OutletAccessory extends BaseAccessory {
  ...
  initConfigProperties(config) {
    ...
    this.showTemperature = this.getPropValue(config['showTemperature'], true);
  }
  ...
  setupAdditionalAccessoryServices() {
    ...
    if (this.showTemperature) this.prepareTemperatureService();
  }
  ...
  prepareOffMemoryService() {
    if (this.getDevice().supportsOffMemory()) {
      this.addPropValueListWrapper('Off Memory', Properties.OFF_MEMORY, null);
    }
  }
