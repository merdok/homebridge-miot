...
class FreshAirSystemAccessory extends GenericAccessory {
  ...
  prepareHeaterControlService() {
    if (this.getDevice().supportsHeater()) {
      this.addPropWrapper('Heater', this.getDevice().heaterProp(), this.getDevice().onProp(), null, null);
    }
  }

  prepareHeatLevelControlServices() {
    if (this.getDevice().supportsHeatLevels()) {
      this.addPropWrapper('Heat Level', this.getDevice().heatLevelProp(), this.getDevice().onProp(), null, null);
    }
  }
