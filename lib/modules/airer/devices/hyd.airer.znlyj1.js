...
class HydAirerZnlyj1 extends AirerDevice {
  ...
  initDeviceProperties() {
    ...
    this.addPropertyByString('airer:target-position', '{"siid":2,"piid":15,"type":"urn:miot-spec-v2:property:target-position:0000003A:hyd-znlyj1:2","description":"Target Position","format":"uint8","access":["read","write","notify"],"unit":"percentage","valueRange":[0,49,1]}');
    this.addPropertyByString('airer:target-position2', '{"siid":2,"piid":16,"type":"urn:miot-spec-v2:property:target-position:0000003A:hyd-znlyj1:2","description":"Target Position","format":"uint8","access":["read","write","notify"],"unit":"percentage","valueRange":[51,100,1]}');
    this.addPropertyByString('airer:on', '{"siid":2,"piid":17,"type":"urn:miot-spec-v2:property:on:00000006:hyd-znlyj1:2","description":"Switch Status","format":"bool","access":["read","write","notify"]}');
