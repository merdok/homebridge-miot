...
class HydAirerZnlyj1 extends AirerDevice {
  ...
  initDeviceProperties() {
    // READ/WRITE
    this.addProperty(AirerProperties.TARGET_POSITION, 2, 15, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [0, 49, 1]);
    this.addProperty(AirerProperties.TARGET_POSITION_2, 2, 16, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [51, 100, 1]);
    this.addProperty(AirerProperties.MOTOR_REVERSE, 2, 8, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE);
    this.addProperty(AirerProperties.POWER, 2, 17, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE);
    ...
    this.addProperty(AirerProperties.CURRENT_POSITION, 2, 3, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, [0, 2, 1]);
  }
