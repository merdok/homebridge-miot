...
class GenericDevice extends MiotDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.POWER, 2, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
  }
  ...
  supportsLedControlBrightness() {
    return this.supportsLedControlRange() && this.ledControlRange()[0] === 0 && this.ledControlRange()[1] === 100 && this.properties[Properties.LED].getUnit() === PropUnit.PERCENTAGE;
  }
  ...
  getShutdownTimer() {
    ...
    if (this.powerOffTimerUnit() === PropUnit.HOURS) {
      value = value * 60;
    } else if (this.powerOffTimerUnit() === PropUnit.SECONDS) {
  ...
  getUseTime() {
    ...
    if (this.useTimeUnit() === PropUnit.HOURS) {
      return useTime * 60;
    } else if (this.useTimeUnit() === PropUnit.SECONDS) {
  ...
  async setShutdownTimer(minutes) {
    let value = minutes;
    if (this.powerOffTimerUnit() === PropUnit.SECONDS) {
      value = minutes * 60;
    } else if (this.powerOffTimerUnit() === PropUnit.HOURS) {
