...
class ChunmiOvenX02 extends OvenDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.COOK_MODE, 2, 4, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, [], [{ // access is [] in the spec so i assume it is read notify
        "value": 0,
        "description": "Cheese"
      },
      {
    ...
    this.addProperty(Properties.COOK_TIME, 2, 11, PropFormat.UINT32, PropAccess.READ_NOTIFY, PropUnit.SECONDS, [0, 4294967295, 1]);
  }
