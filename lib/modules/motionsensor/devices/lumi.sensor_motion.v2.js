...
class LumiSensor_motionV2 extends MotionSensorDevice {
  ...
  initDeviceProperties() {
    this.addPropertyByString('motion-sensor:motion-state', '{"siid":2,"piid":1,"type":"urn:miot-spec-v2:property:motion-state:0000007D:lumi-v2:1","description":"Motion State","format":"bool","access":["read","notify"]}');
  }
