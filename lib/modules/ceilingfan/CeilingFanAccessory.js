  ...
  prepareFanLevelControlService() {
    if (this.fanLevelControl && this.miotCellingFanDevice.supportsFanLevels()) {
      ...
      this.miotCellingFanDevice.fanLevels().forEach((fanLevel, i) => {
        ...
        let tmpFanLevelButton = new Service.Switch('Fan Level - ' + fanLevelName, 'levelControlService' + fanLevelValue);
        tmpFanLevelButton
          .getCharacteristic(Characteristic.On)
          .onGet(() => {
  ...
  updateFanLevelSwitches() {
    if (this.fanLevelControlService) {
      ...
      this.fanLevelControlService.forEach((tmpFanLevelButton, i) => {
        ...
        tmpFanLevelButton.getCharacteristic(Characteristic.On).updateValue(isSwitchOn);
      });
    }
  }
