...
class CeilingFanAccessory extends BaseAccessory {
  ...
  setupAdditionalAccessoryServices() {
    if (this.actionButtons) this.prepareActionButtonServices();
  ...
  prepareLightModeControlServices() {
    if (this.getDevice().supportsLightModes()) {
      this.addPropValueListService('Light Mode', this.getDevice().lightModeProperty(), this.getDevice().lightPowerProperty());
    }
  }
