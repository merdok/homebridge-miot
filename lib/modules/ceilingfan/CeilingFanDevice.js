...
class CeilingFanDevice extends GenericDevice {
  ...
  // light modes
  lightModes() {
    return this.getPropertyValueList(CeilingFanProperties.LIGH_MODE);
  }
  ...
  getLightMode() {
    return this.getPropertyValue(CeilingFanProperties.LIGH_MODE);
  }
  ...
  setLightMode(lightMode) {
    return this.setPropertyValue(CeilingFanProperties.LIGH_MODE, lightMode);
  }
