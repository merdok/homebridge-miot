...
class OppleLightFanlight extends CeilingFanDevice {
  ...
  initDeviceProperties() {
    this.addProperty(CeilingFanProperties.LIGHT_POWER, 2, 1, PropFormat.BOOL, PropAccess.READ_WRITE, PropUnit.NONE, null);
    this.addProperty(CeilingFanProperties.LIGHT_MODE, 2, 2, PropFormat.UINT8, PropAccess.READ_WRITE, PropUnit.NONE, null, [{
        "value": 1,
    ...
    this.addProperty(CeilingFanProperties.MODE, 3, 3, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 1,
        "description": "NONE"
      },
      {
