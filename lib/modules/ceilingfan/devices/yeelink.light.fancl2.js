...
class YeelinkLightFancl2 extends CeilingFanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.POWER_OFF_TIME, 3, 11, PropFormat.UINT32, PropAccess.READ_WRITE_NOTIFY, PropUnit.MINUTES, [0, 720, 1]);
    this.addProperty(Properties.FAN_SPEED, 5, 4, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [1, 100, 1]);
