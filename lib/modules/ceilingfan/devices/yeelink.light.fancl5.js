...
class YeelinkLightFancl5 extends CeilingFanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.LIGHT_MODE, 2, 7, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 0,
        "description": "Day"
      },
      {
    ...
    this.addProperty(Properties.COLOR_TEMP, 2, 5, PropFormat.UINT32, PropAccess.READ_WRITE_NOTIFY, PropUnit.KELVIN, [2700, 6500, 1]);
    this.addProperty(Properties.LIGHT_POWER_OFF_TIME, 4, 4, PropFormat.UINT32, PropAccess.READ_WRITE_NOTIFY, PropUnit.MINUTES, [0, 180, 1]);
    ...
    this.addProperty(Properties.MODE, 3, 4, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 0,
        "description": "Auto"
      },
      {
    ...
    this.addProperty(Properties.POWER_OFF_TIME, 3, 10, PropFormat.UINT32, PropAccess.READ_WRITE_NOTIFY, PropUnit.MINUTES, [0, 720, 1]);
    this.addProperty(Properties.FAN_SPEED, 5, 7, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [1, 100, 1]);

    // READ ONLY
    this.addProperty(Properties.STATUS, 3, 3, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, [], [{
        "value": 1,
        "description": "Idle"
      },
      {
