...
class ZhimiHeaterZb1 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 6, Constants.PROP_FORMAT_FLOAT, ['read', 'write', 'notify'], Constants.PROP_UNIT_CELSIUS, [16, 28, 1]);
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 4, 1, Constants.PROP_FORMAT_UINT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_HOURS, [0, 8, 1]);
    ...
    this.addProperty(HeaterProperties.COUNTRY_CODE, 8, 8, Constants.PROP_FORMAT_INT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);

    this.addProperty(HeaterProperties.RELATIVE_HUMIDITY, 5, 7, Constants.PROP_FORMAT_UINT8, ['read', 'notify'], Constants.PROP_UNIT_PERCENTAGE, [0, 100, 1]);
    this.addProperty(HeaterProperties.TEMPERATURE, 5, 8, Constants.PROP_FORMAT_FLOAT, ['read', 'notify'], Constants.PROP_UNIT_CELSIUS, [-30, 100, 0.1]);
    this.addProperty(HeaterProperties.USE_TIME, 8, 7, Constants.PROP_FORMAT_UINT32, ['read', 'notify'], Constants.PROP_UNIT_SECONDS, [0, 4294967295, 1]);
  }
