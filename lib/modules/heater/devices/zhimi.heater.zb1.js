...
class ZhimiHeaterZb1 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 4, 1, 'uint32', ['read', 'write', 'notify'], Constants.TIME_UNIT_HOURS, [0, 8, 1]);
    ...
    this.addProperty(HeaterProperties.COUNTRY_CODE, 8, 8, 'int32', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    ...
    this.addProperty(HeaterProperties.USE_TIME, 8, 7, 'uint32', ['read', 'notify'], Constants.TIME_UNIT_SECONDS, [0, 4294967295, 1]);
  }
