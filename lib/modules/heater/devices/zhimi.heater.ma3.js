...
class ZhimiHeaterMa3 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 5, 'float', ['read', 'write', 'notify'], Constants.PROP_UNIT_CELSIUS, [16, 28, 1]);
    this.addProperty(HeaterProperties.MODE, 2, 6, 'uint8', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 3, 1, 'uint32', ['read', 'write', 'notify'], Constants.PROP_UNIT_SECONDS, [0, 43200, 1]);
    this.addProperty(HeaterProperties.CHILD_LOCK, 5, 1, 'bool', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(HeaterProperties.LED, 7, 3, 'uint8', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, [0, 2, 1]);
    ...
    this.addProperty(HeaterProperties.USE_TIME, 8, 9, 'uint32', ['read', 'notify'], Constants.PROP_UNIT_SECONDS, [0, 2147483647, 1]);
  }
  ...
  initDeviceCapabilities() {
    ...
    this.addCapability(HeaterCapabilities.POWER_OFF_TIMER_UNIT, Constants.PROP_UNIT_SECONDS);
    this.addCapability(HeaterCapabilities.POWER_OFF_TIMER_RANGE, [0, 43200, 1]);
    this.addCapability(HeaterCapabilities.USE_TIME_UNIT, Constants.PROP_UNIT_SECONDS);
