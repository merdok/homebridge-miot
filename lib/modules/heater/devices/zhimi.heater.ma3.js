...
class ZhimiHeaterMa3 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.MODE, 2, 6, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
        "description": "Auto"
      },
      {
    ...
    this.addProperty(HeaterProperties.LED, 7, 3, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [0, 2, 1], [{ // same here to remove the value range since it does not have any!!!
        "value": 0,
        "description": "Bright"
      },
      {
