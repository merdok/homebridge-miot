...
class ZhimiHeaterMa3 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 5, PropFormat.FLOAT, ['read', 'write', 'notify'], Constants.PROP_UNIT_CELSIUS, [16, 28, 1]);
    this.addProperty(HeaterProperties.MODE, 2, 6, PropFormat.UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null, [{
        "value": 0,
        "description": "Auto"
      },
      {
    ...
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 3, 1, PropFormat.UINT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_SECONDS, [0, 43200, 1]);
    this.addProperty(HeaterProperties.CHILD_LOCK, 5, 1, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(HeaterProperties.LED, 7, 3, PropFormat.UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, [0, 2, 1], [{ // same here to remove the value range since it does not have any!!!
        "value": 0,
        "description": "Bright"
      },
      {
