...
class ZhimiHeaterMa3 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.LED, 7, 3, Constants.PROP_FORMAT_UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, [0, 2, 1], [{ // same here to remove the value range since it does not have any!!!
        "value": 0,
        "description": "Bright"
      },
      {
