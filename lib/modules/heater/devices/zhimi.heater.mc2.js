...
class ZhimiHeaterMc2 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 5, PropFormat.FLOAT, ['read', 'write', 'notify'], PropUnit.CELSIUS, [18, 28, 1]);
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 3, 1, PropFormat.UINT32, ['read', 'write', 'notify'], PropUnit.HOURS, [0, 12, 1]);
    this.addProperty(HeaterProperties.CHILD_LOCK, 5, 1, PropFormat.BOOL, ['read', 'write', 'notify'], PropUnit.NONE, null);
    this.addProperty(HeaterProperties.LED, 7, 3, PropFormat.UINT8, ['read', 'write', 'notify'], PropUnit.NONE, [0, 1, 1]);
    ...
    this.addProperty(HeaterProperties.COUNTRY_CODE, 8, 10, PropFormat.INT32, ['read', 'notify'], PropUnit.NONE, null);
  }
