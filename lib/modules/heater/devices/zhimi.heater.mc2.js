...
class ZhimiHeaterMc2 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 5, Constants.PROP_FORMAT_FLOAT, ['read', 'write', 'notify'], Constants.PROP_UNIT_CELSIUS, [18, 28, 1]);
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 3, 1, Constants.PROP_FORMAT_UINT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_HOURS, [0, 12, 1]);
    ...
    this.addProperty(HeaterProperties.LED, 7, 3, Constants.PROP_FORMAT_UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, [0, 1, 1]);
    ...
    this.addProperty(HeaterProperties.COUNTRY_CODE, 8, 10, Constants.PROP_FORMAT_INT32, ['read', 'notify'], Constants.PROP_UNIT_NONE, null);
  }
