...
class LeshowHeaterBs1s extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.TARGET_TEMPERATURE, 2, 3, PropFormat.FLOAT, PropAccess.READ_WRITE_NOTIFY, PropUnit.CELSIUS, [18, 28, 1]);
    this.addProperty(Properties.TEMPERATURE, 2, 4, PropFormat.FLOAT, PropAccess.READ_NOTIFY, PropUnit.CELSIUS, [-30, 100, 0.1]);
