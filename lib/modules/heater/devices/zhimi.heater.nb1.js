...
class ZhimiHeaterNb1 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.TARGET_TEMPERATURE, 2, 5, PropFormat.FLOAT, ['read', 'write', 'notify'], Constants.PROP_UNIT_CELSIUS, [16, 30, 1]);
    ...
    this.addProperty(HeaterProperties.COUNTRY_CODE, 8, 4, PropFormat.INT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);

    this.addProperty(HeaterProperties.TEMPERATURE, 9, 7, PropFormat.FLOAT, ['read', 'notify'], Constants.PROP_UNIT_CELSIUS, [-30, 100, 0.1]);
  }
