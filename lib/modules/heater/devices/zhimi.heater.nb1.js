...
class ZhimiHeaterZa2 extends HeaterDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HeaterProperties.HEAT_LEVEL, 2, 3, 'uint8', ['read', 'write', 'notify'], Constants.PROP_UNIT_LEVEL, null); // high and low? add buttons for that like fan buttons?
    ...
    this.addProperty(HeaterProperties.POWER_OFF_TIME, 4, 1, 'uint32', ['read', 'write', 'notify'], Constants.TIME_UNIT_HOURS, [0, 12, 1]);
