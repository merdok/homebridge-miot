...
class HeaterDevice extends MiotDevice {
  ...
  supportsTargetTemperature() {
    return this.properties[HeaterProperties.TARGET_TEMPERATURE] !== undefined || false;
  }

  targetTemperatureRange() {
    return this.supportsTargetTemperature() ? this.properties[HeaterProperties.TARGET_TEMPERATURE].getValueRange() : [];
  }
  ...
  getTargetTemperature() {
    return this.getPropertyValueAdjustedToRange(HeaterProperties.TARGET_TEMPERATURE);
  }
