...
class HeaterAccessory {
  constructor(name, miotDevice, uuid, log, config, api, logger) {
    ...
    this.childLockControl = config['childLockControl'];
    if (this.childLockControl == undefined) {
      this.childLockControl = false;
    }
  ...
  getCurrentHeatingCoolingState() {
    if (this.miotHeaterDevice && this.miotHeaterDevice.isConnected()) {
