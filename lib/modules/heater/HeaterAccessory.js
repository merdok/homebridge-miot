  ...
  prepareHeatLevelControlService() {
    if (this.heatLevelControl && this.miotHeaterDevice.supportsHeatLevels()) {
      ...
      this.miotHeaterDevice.heatLevels().forEach((heatLevel, i) => {
        ...
        let tmpHeatLevelButton = new Service.Switch(this.name + ' Heat ' + heatLevelName, 'heatLevelControlService' + heatLevelValue);
        tmpHeatLevelButton
          .getCharacteristic(Characteristic.On)
          .onGet(() => {
        ...
        this.accessory.addService(tmpHeatLevelButton);
