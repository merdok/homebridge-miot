...
class AirPurifierAccessory extends GenericAccessory {
  ...
  prepareFanLevelControlServices() {
    if (this.getDevice().supportsFanLevel()) {
      this.addPropWrapper('Fan Level', this.getDevice().fanLevelProp(), this.getDevice().modeProp(), null, this.getDevice().favoriteModeValue());
    }
  }
