...
class ZhimiAirPurifierZa1 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 5, 'uint16', ['read', 'notify'], Constants.TIME_UNIT_HOURS, [0, 15000, 1]);
    this.addProperty(AirPurifierProperties.FAN_SPEED_RPM, 10, 11, 'uint16', ['read'], Constants.PROP_UNIT_RPM, [0, 3000, 1]);
    this.addProperty(AirPurifierProperties.USE_TIME, 12, 1, 'uint32', ['read'], Constants.TIME_UNIT_SECONDS, [0, 2147483600, 1]);
