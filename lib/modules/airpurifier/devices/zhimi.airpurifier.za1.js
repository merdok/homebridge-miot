...
class ZhimiAirPurifierZa1 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.COUNTRY_CODE, 15, 12, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    ...
    this.addProperty(AirPurifierProperties.AQI_STATE, 13, 4, PropFormat.STRING, PropAccess.READ, PropUnit.NONE, null); // marked as aqi zone, so is this the state in text form?
  }
