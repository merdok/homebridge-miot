...
class ZhimiAirPurifierMb3 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.FAVORITE_SPEED, 10, 7, PropFormat.INT32, ['read', 'write'], PropUnit.RPM, [300, 2300, 1]);
    ...
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 5, PropFormat.UINT16, ['read', 'notify'], PropUnit.HOURS, [0, 10000, 1]);
    this.addProperty(AirPurifierProperties.FAN_SPEED_RPM, 10, 8, PropFormat.INT32, ['read'], PropUnit.RPM, [0, 3000, 1]);
    this.addProperty(AirPurifierProperties.USE_TIME, 12, 1, PropFormat.INT32, ['read'], PropUnit.SECONDS, [0, 2147483600, 1]);
