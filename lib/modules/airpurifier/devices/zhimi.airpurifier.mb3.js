...
class ZhimiAirPurifierMb3 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.FAVORITE_SPEED, 10, 7, 'int32', ['read', 'write'], Constants.PROP_UNIT_RPM, [300, 2300, 1]);
    ...
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 5, 'uint16', ['read', 'notify'], Constants.TIME_UNIT_HOURS, [0, 10000, 1]);
    this.addProperty(AirPurifierProperties.FAN_SPEED_RPM, 10, 8, 'int32', ['read'], Constants.PROP_UNIT_RPM, [0, 3000, 1]);
    this.addProperty(AirPurifierProperties.USE_TIME, 12, 1, 'int32', ['read'], Constants.TIME_UNIT_SECONDS, [0, 2147483600, 1]);
