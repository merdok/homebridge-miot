...
class ZhimiAirPurifierMb3 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.FAVORITE_SPEED, 10, 7, PropFormat.INT32, PropAccess.READ_WRITE, PropUnit.RPM, [300, 2300, 1]);
    ...
    this.addProperty(Properties.FILTER_USED_TIME, 4, 5, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 10000, 1]);
    this.addProperty(Properties.FAN_SPEED_RPM, 10, 8, PropFormat.INT32, PropAccess.READ, PropUnit.RPM, [0, 3000, 1]);
    this.addProperty(Properties.USE_TIME, 12, 1, PropFormat.INT32, PropAccess.READ, PropUnit.SECONDS, [0, 2147483600, 1]);
