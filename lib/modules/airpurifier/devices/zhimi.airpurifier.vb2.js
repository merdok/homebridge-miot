...
class ZhimiAirPurifierVb2 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    this.addProperty(AirPurifierProperties.POWER, 2, 2, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(AirPurifierProperties.FAN_LEVEL, 2, 4, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 1,
        "description": "Level1"
      },
      {
    ...
    this.addProperty(AirPurifierProperties.MODE, 2, 5, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
        "description": "Auto"
      },
      {
    ...
    this.addProperty(AirPurifierProperties.CHILD_LOCK, 7, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(AirPurifierProperties.LED, 6, 1, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [0, 2, 1], [{
        "value": 0,
    ...
    this.addProperty(AirPurifierProperties.ALARM, 5, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    ...
    this.addProperty(AirPurifierProperties.AQI_STATE, 13, 8, PropFormat.INT32, PropAccess.READ, PropUnit.NONE, null, [{
        "value": 0,
