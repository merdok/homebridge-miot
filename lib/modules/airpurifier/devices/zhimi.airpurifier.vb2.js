...
class ZhimiAirPurifierVb2 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    this.addProperty(AirPurifierProperties.POWER, 2, 2, PropFormat.BOOL, ['read', 'write', 'notify'], PropUnit.NONE, null);
    this.addProperty(AirPurifierProperties.FAN_LEVEL, 2, 4, PropFormat.UINT8, ['read', 'write', 'notify'], PropUnit.NONE, null, [{
        "value": 1,
        "description": "Level1"
      },
      {
    ...
    this.addProperty(AirPurifierProperties.FAVORITE_SPEED, 10, 7, PropFormat.INT32, ['read', 'write'], PropUnit.RPM, [300, 2300, 10]);
    ...
    this.addProperty(AirPurifierProperties.PM25_DENSITY, 3, 6, PropFormat.FLOAT, ['read', 'notify'], PropUnit.NONE, [0, 600, 1]);
    this.addProperty(AirPurifierProperties.RELATIVE_HUMIDITY, 3, 7, PropFormat.UINT8, ['read', 'notify'], PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(AirPurifierProperties.TEMPERATURE, 3, 8, PropFormat.FLOAT, ['read', 'notify'], PropUnit.CELSIUS, [-40, 125, 0.1]);
    this.addProperty(AirPurifierProperties.FILTER_LIFE_LEVEL, 4, 3, PropFormat.UINT8, ['read', 'notify'], PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 5, PropFormat.UINT16, ['read', 'notify'], PropUnit.HOURS, [0, 18000, 1]);
    this.addProperty(AirPurifierProperties.FAN_SPEED_RPM, 10, 8, PropFormat.INT32, ['read'], PropUnit.RPM, [0, 10000, 1]);
    this.addProperty(AirPurifierProperties.USE_TIME, 12, 1, PropFormat.INT32, ['read'], PropUnit.SECONDS, [0, 2147483647, 1]);
    this.addProperty(AirPurifierProperties.AQI_STATE, 13, 8, PropFormat.INT32, ['read'], PropUnit.NONE, null, [{
        "value": 0,
    ...
    this.addProperty(AirPurifierProperties.AQI_VALUE, 13, 2, PropFormat.INT32, ['read'], PropUnit.NONE, [0, 600, 1]);
  }
