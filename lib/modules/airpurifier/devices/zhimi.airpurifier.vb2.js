...
class ZhimiAirPurifierVb2 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    //this.addProperty(AirPurifierProperties.ALARM, 5, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE); // present in the specs but does not actually work, why?
    this.addProperty(AirPurifierProperties.FAVORITE_LEVEL, 10, 10, PropFormat.INT32, PropAccess.READ_WRITE, PropUnit.NONE, [0, 9, 1]);
    ...
    this.addProperty(AirPurifierProperties.FAVORITE_SPEED, 10, 7, PropFormat.INT32, PropAccess.READ, PropUnit.RPM, [300, 2300, 10]);
