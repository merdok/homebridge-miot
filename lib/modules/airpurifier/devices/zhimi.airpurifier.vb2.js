...
class ZhimiAirPurifierVb2 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.FAVORITE_SPEED, 10, 7, PropFormat.INT32, ['read', 'write'], Constants.PROP_UNIT_RPM, [300, 2300, 10]);
    ...
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 5, PropFormat.UINT16, ['read', 'notify'], Constants.PROP_UNIT_HOURS, [0, 18000, 1]);
    this.addProperty(AirPurifierProperties.FAN_SPEED_RPM, 10, 8, PropFormat.INT32, ['read'], Constants.PROP_UNIT_RPM, [0, 10000, 1]);
    this.addProperty(AirPurifierProperties.USE_TIME, 12, 1, PropFormat.INT32, ['read'], Constants.PROP_UNIT_SECONDS, [0, 2147483647, 1]);
