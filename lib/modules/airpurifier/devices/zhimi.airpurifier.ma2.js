...
class ZhimiAirPurifierMa2 extends AirPurifierDevice {
  ...
  getDeviceMiotSpec() {
    return "http://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-ma2:1";
  }
  ...
  initDeviceProperties() {
    ...
    this.addProperty(AirPurifierProperties.FILTER_USED_TIME, 4, 2, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 10000, 1]);
  }
