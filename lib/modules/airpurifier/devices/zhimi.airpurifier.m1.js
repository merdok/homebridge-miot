...
class ZhimiAirPurifierM1 extends AirPurifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.FAVORITE_LEVEL, 10, 10, PropFormat.INT32, PropAccess.READ_WRITE, PropUnit.NONE, [0, 14, 1]);
    ...
    this.addProperty(Properties.FILTER_USED_TIME, 4, 2, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 6000, 1]);
  }
