...
class AirPurifierDevice extends BaseDevice {
  ...
  favoriteSpeedMinVal() {
    if (this.supportsFavoriteLevelsRange()) {
      return this.favoriteLevelsRange()[0];
    } else if (this.supportsFavoriteSpeedRange()) {
      return this.favoriteSpeedRange()[0];
    }
    return 0;
  }
  ...
  favoriteSpeedMaxVal() {
    if (this.supportsFavoriteLevelsRange()) {
      return this.favoriteLevelsRange()[1];
    } else if (this.supportsFavoriteSpeedRange()) {
      return this.favoriteSpeedRange()[1];
    }
    return 100;
  }

  favoriteSpeedStepVal() {
    if (this.supportsFavoriteLevelsRange()) {
      return this.favoriteLevelsRange()[2];
    } else if (this.supportsFavoriteSpeedRange()) {
      return this.favoriteSpeedRange()[2];
    }
    return 1;
  }
