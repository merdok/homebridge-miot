...
class DooyaCurtainM2 extends CurtainDevice {
  ...
  initDeviceCapabilities() {
    this.addCapability(CurtainCapabilities.STATUS_CLOSING_VALUE, 0);
    this.addCapability(CurtainCapabilities.STATUS_STOP_VALUE, 1);
    this.addCapability(CurtainCapabilities.STATUS_OPENING_VALUE, 2);
  }
