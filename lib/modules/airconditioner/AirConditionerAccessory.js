...
class AirConditionerAccessory extends BaseAccessory {
  ...
  updateDeviceStatus() {
    ...
    if (this.airConditionerService && this.getDevice().supportsSwingModes()) this.airConditionerService.getCharacteristic(Characteristic.SwingMode).updateValue(this.getSwingModeState());
