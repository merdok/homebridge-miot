...
class DeermaHumidifierJsq4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HumidifierProperties.LED, 3, 6, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(HumidifierProperties.ALARM, 3, 5, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
