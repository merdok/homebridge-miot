...
class DeermaHumidifierJsq4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HumidifierProperties.LED, 3, 6, 'bool', ['read', 'write', 'notify'], Constants.PROP_UNIT_LEVEL, null);
    this.addProperty(HumidifierProperties.ALARM, 3, 5, 'bool', ['read', 'write', 'notify'], Constants.PROP_UNIT_LEVEL, null);
