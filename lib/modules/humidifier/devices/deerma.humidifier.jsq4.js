...
class DeermaHumidifierJsq4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.DEVICE_FAULT, 2, 2, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, [], [{
      ...
      {
        "value": 1,
        "description": "Insufficient Water"
      },
      {
        "value": 2,
        "description": "Water Separation"
      }
    ]);
    ...
    this.addProperty(Properties.WATER_SHORTAGE_FAULT, 7, 1, PropFormat.BOOL, PropAccess.READ_NOTIFY, PropUnit.NONE);
  }
