...
class ZhimiHumidifierCa4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    this.addProperty(HumidifierProperties.POWER, 2, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(HumidifierProperties.FAN_LEVEL, 2, 5, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
        "description": "Auto"
      },
      {
    ...
    this.addProperty(HumidifierProperties.DRY_MODE, 2, 8, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(HumidifierProperties.CHILD_LOCK, 6, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(HumidifierProperties.SCREEN, 5, 2, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [0, 2, 1], [{
        "value": 0,
        "description": "Dark"
      },
      {
    ...
    this.addProperty(HumidifierProperties.ALARM, 4, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    ...
    this.addProperty(HumidifierProperties.ACTUAL_SPEED, 7, 1, PropFormat.UINT32, PropAccess.READ_NOTIFY, PropUnit.RPM, [0, 2000, 1]);
