...
class ZhimiHumidifierCa4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HumidifierProperties.USE_TIME, 2, 9, 'uint32', ['read', 'write', 'notify'], Constants.TIME_UNIT_SECONDS, [0, 2147483600, 1]);
    this.addProperty(HumidifierProperties.POWER_TIME, 7, 3, 'uint32', ['read', 'write', 'notify'], Constants.TIME_UNIT_SECONDS, [0, 4294967295, 1]);
  }
