...
class ZhimiHumidifierCa4 extends HumidifierDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(HumidifierProperties.DRY, 2, 8, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE);
    this.addProperty(HumidifierProperties.CHILD_LOCK, 6, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE);
    this.addProperty(HumidifierProperties.SCREEN, 5, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE); // undocumented property, not tested!
    this.addProperty(HumidifierProperties.SCREEN_BRIGHTNESS, 5, 2, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 0,
        "description": "Dark"
      },
      {
