...
class FanAccessory extends BaseAccessory {
  ...
  prepareHorizontalAngleButtonsService() {
    if (this.getDevice().supportsHorizontalSwingAngle()) {
      this.addAngleButtonsService('Horizontal Angle', FanProperties.HORIZONTAL_SWING_ANGLE, FanProperties.HORIZONTAL_SWING, this.horizontalAngleButtons);
    }
  }

  prepareVerticalAngleButtonsService() {
    if (this.getDevice().supportsVerticalSwingAngle()) {
      this.addAngleButtonsService('Vertical Angle', FanProperties.VERTICAL_SWING_ANGLE, FanProperties.VERTICAL_SWING, this.verticalAngleButtons);
    }
  }
