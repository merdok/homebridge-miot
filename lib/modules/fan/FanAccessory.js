...
class FanAccessory extends BaseAccessory {
  ...
  prepareHorizontalAngleButtonsWrapper() {
    if (this.getDevice().supportsHorizontalSwingAngle()) {
      this.addAngleButtonsWrapper('Horizontal Angle', Properties.HORIZONTAL_SWING_ANGLE, Properties.HORIZONTAL_SWING, this.horizontalAngleButtons);
    }
  }

  prepareVerticalAngleButtonsWrapper() {
    if (this.getDevice().supportsVerticalSwingAngle()) {
      this.addAngleButtonsWrapper('Vertical Angle', Properties.VERTICAL_SWING_ANGLE, Properties.VERTICAL_SWING, this.verticalAngleButtons);
    }
  }
  ...
  addAngleButtonsWrapper(serviceName, propName, linkedPropName, angleButtonsConfig) {
    this.addPropWrapper(AngleButtonsWrapper, serviceName, propName, linkedPropName, angleButtonsConfig);
  }
