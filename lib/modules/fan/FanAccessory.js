...
class FanAccessory extends GenericAccessory {
  ...
  prepareSwingControlService() {
    if (this.getDevice().supportsHorizontalSwing()) {
      this.addPropWrapper('Horizontal Swing', this.getDevice().horizontalSwingProp(), null, null);
    }

    if (this.getDevice().supportsVerticalSwing()) {
      this.addPropWrapper('Vertical Swing', this.getDevice().verticalSwingProp(), null, null);
    }
  }
  ...
  addAngleButtonsWrapper(serviceName, prop, linkedProp, angleButtonsConfig) {
    return this.createAndAddWrapper(AngleButtonsWrapper, serviceName, prop, linkedProp, null, null, angleButtonsConfig);
  }
