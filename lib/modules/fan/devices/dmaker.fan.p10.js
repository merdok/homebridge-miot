...
class DmakerFanP10 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 2, 6, 'uint32', ['read', 'write', 'notify']);
    this.addProperty(FanProperties.CHILD_LOCK, 3, 1, 'bool', ['read', 'write', 'notify']);
    this.addProperty(FanProperties.LIGHT, 2, 7, 'uint8', ['read', 'write', 'notify']);
    this.addProperty(FanProperties.ALARM, 2, 8, 'bool', ['read', 'write', 'notify']);
    this.addProperty(FanProperties.FAN_SPEED, 2, 10, 'uint8', ['read', 'write', 'notify']);

    this.addProperty(FanProperties.HORIZONTAL_MOVE, 2, 9, 'uint8', ['write']);
  }
  ...
  initDeviceCapabilities() {
    ...
    this.addCapability(FanCapabilities.POWER_OFF_TIMER_UNIT, Constants.TIME_UNIT_MINUTES);
