...
class DmakerFanP10 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.LED, 2, 7, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.ALARM, 2, 8, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.FAN_SPEED, 2, 10, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);

    this.addProperty(FanProperties.HORIZONTAL_MOVE, 2, 9, PropFormat.UINT8, PropAccess.WRITE, PropUnit.NONE, null, [{
        "value": 0,
        "description": "NO"
      },
      {
