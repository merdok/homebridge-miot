...
class DmakerFanP10 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 2, 6, PropFormat.UINT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_MINUTES, [0, 480, 1]);
    this.addProperty(FanProperties.CHILD_LOCK, 3, 1, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.LED, 2, 7, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.ALARM, 2, 8, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.FAN_SPEED, 2, 10, PropFormat.UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_PERCENTAGE, [0, 100, 1]);

    this.addProperty(FanProperties.HORIZONTAL_MOVE, 2, 9, PropFormat.UINT8, ['write'], Constants.PROP_UNIT_NONE, null, [{
        "value": 0,
        "description": "NO"
      },
      {
