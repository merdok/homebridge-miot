...
class DmakerFanP9 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.HORIZONTAL_SWING, 2, 5, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.HORIZONTAL_SWING_ANGLE, 2, 6, PropFormat.UINT16, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 30,
        "description": "30"
      },
      {
    ...
    this.addProperty(FanProperties.MODE, 2, 4, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
    ...
    this.addProperty(FanProperties.LED, 2, 9, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.ALARM, 2, 7, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.FAN_SPEED, 2, 11, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);

    this.addProperty(FanProperties.HORIZONTAL_MOVE, 2, 10, PropFormat.UINT8, PropAccess.WRITE, PropUnit.NONE, null, [{
        "value": 0,
        "description": "None"
      },
      {
