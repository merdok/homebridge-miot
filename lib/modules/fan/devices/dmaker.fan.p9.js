...
class DmakerFanP9 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.HORIZONTAL_SWING, 2, 5, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.HORIZONTAL_SWING_ANGLE, 2, 6, PropFormat.UINT16, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null, [{
        "value": 30,
        "description": "30"
      },
      {
    ...
    this.addProperty(FanProperties.MODE, 2, 4, PropFormat.UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null, [{
        "value": 0,
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 2, 8, PropFormat.UINT32, ['read', 'write', 'notify'], Constants.PROP_UNIT_MINUTES, [0, 480, 1]);
    this.addProperty(FanProperties.CHILD_LOCK, 3, 1, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.LED, 2, 9, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.ALARM, 2, 7, PropFormat.BOOL, ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.FAN_SPEED, 2, 11, PropFormat.UINT8, ['read', 'write', 'notify'], Constants.PROP_UNIT_PERCENTAGE, [0, 100, 1]);

    this.addProperty(FanProperties.HORIZONTAL_MOVE, 2, 10, PropFormat.UINT8, ['write'], Constants.PROP_UNIT_NONE, null, [{
        "value": 0,
        "description": "None"
      },
      {
