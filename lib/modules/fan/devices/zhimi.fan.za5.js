...
class ZhimiFanZa5 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 2, 10, 'uint32', ['read', 'write', 'notify'], Constants.PROP_UNIT_SECONDS, [0, 36000, 1]);
  ...
  initDeviceCapabilities() {
    ...
    this.addCapability(FanCapabilities.POWER_OFF_TIMER_UNIT, Constants.PROP_UNIT_SECONDS);
