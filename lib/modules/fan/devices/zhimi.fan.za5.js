...
class ZhimiFanZa5 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.LIGHT, 4, 3, 'uint8', ['read', 'write', 'notify']);
  ...
  isLedEnabled() {
    return this.getPropertyValue(FanProperties.LIGHT) > 0;
  }
  ...
  async setLedEnabled(enabled) {
    ...
    this.setPropertyValue(FanProperties.LIGHT, value);
  }

  async setLedBrightness(brightness) {
    this.setPropertyValue(FanProperties.LIGHT, brightness);
  }
