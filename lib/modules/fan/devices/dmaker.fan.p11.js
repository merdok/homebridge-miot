...
class DmakerFanP11 extends DmakerFanP10 {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.HORIZONTAL_SWING, 2, 4, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.HORIZONTAL_SWING_ANGLE, 2, 5, PropFormat.UINT16, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 30,
        "description": "30"
      },
      {
    ...
    this.addProperty(FanProperties.MODE, 2, 3, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
    ...
    this.addProperty(FanProperties.CHILD_LOCK, 7, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.LED, 4, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    ...
    //WRITE ONLY
    this.addProperty(FanProperties.HORIZONTAL_MOVE, 6, 1, PropFormat.UINT8, PropUnit.NONE, null, PropAccess.WRITE, [{
        "value": 0,
        "description": "NONE"
      },
      {
