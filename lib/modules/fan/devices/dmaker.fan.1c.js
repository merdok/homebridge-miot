...
class DmakerFan1C extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 2, 10, 'uint16', ['read', 'write', 'notify'], Constants.TIME_UNIT_MINUTES, [0, 480, 1]);
    this.addProperty(FanProperties.ALARM, 2, 11, 'bool', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
    this.addProperty(FanProperties.LED, 2, 12, 'bool', ['read', 'write', 'notify'], Constants.PROP_UNIT_NONE, null);
