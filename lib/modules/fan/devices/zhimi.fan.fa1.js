...
class ZhimiFanFa1 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.VERTICAL_SWING, 2, 4, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    ...
    this.addProperty(FanProperties.CHILD_LOCK, 6, 1, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.LED, 2, 10, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [0, 1, 1]);
    this.addProperty(FanProperties.ALARM, 2, 11, PropFormat.BOOL, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, null);
    this.addProperty(FanProperties.FAN_SPEED, 5, 10, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [1, 100, 1]);

    // WRITE ONLY
    this.addProperty(FanProperties.HORIZONTAL_MOVE, 5, 6, PropFormat.STRING, PropAccess.WRITE, PropUnit.NONE, null);
    this.addProperty(FanProperties.VERTICAL_MOVE, 5, 7, PropFormat.STRING, PropAccess.WRITE, PropUnit.NONE, null);

    // READ ONLY
    this.addProperty(FanProperties.STATUS, 2, 8, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, null, [{
        "value": 1,
        "description": "Idle"
      },
      {
    ...
    this.addProperty(FanProperties.DEVICE_FAULT, 2, 9, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.NONE, null, [{
        "value": 0,
