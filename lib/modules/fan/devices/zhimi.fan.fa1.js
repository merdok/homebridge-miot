...
class ZhimiFanFa1 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(FanProperties.POWER_OFF_TIME, 5, 2, 'uint32', ['read', 'write', 'notify'], Constants.TIME_UNIT_HOURS, [0, 8, 1]);
  ...
  initDeviceCapabilities() {
    ...
    this.addCapability(FanCapabilities.POWER_OFF_TIMER_UNIT, Constants.TIME_UNIT_HOURS);
