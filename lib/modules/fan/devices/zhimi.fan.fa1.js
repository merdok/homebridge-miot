...
class ZhimiFanFa1 extends FanDevice {
  ...
  initDeviceProperties() {
    ...
    // READ ONLY
    this.addProperty(FanProperties.STATUS, 2, 8, Constants.PROP_FORMAT_UINT8, ['read', 'notify'], Constants.PROP_UNIT_NONE, null, [{
        "value": 1,
        "description": "Idle"
      },
      {
    ...
    this.addProperty(FanProperties.DEVICE_FAULT, 2, 9, Constants.PROP_FORMAT_UINT8, ['read', 'notify'], Constants.PROP_UNIT_NONE, null, [{
        "value": 0,
