...
class RobotCleanerMatterAccessory {
  ...
  _getOperationalStateList() {
    return Object.values(MATTER_RVC_OPERATIONAL_STATES).map(operationalStateId => ({
      operationalStateId,
      ...(operationalStateId === MATTER_RVC_OPERATIONAL_STATES.READY ? { operationalStateLabel: 'Ready' } : {})
    }));
  }
