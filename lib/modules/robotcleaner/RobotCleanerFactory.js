...
const DreameVacuumP2157 = require('./devices/dreame.vacuum.p2157.js');
const ViomiVacuumV18 = require('./devices/viomi.vacuum.v18.js');
const RoborockVacuumA29 = require('./devices/roborock.vacuum.a29.js');
const RoidmiVacuumV60 = require('./devices/roidmi.vacuum.v60.js');
const RoborockVacuumA10 = require('./devices/roborock.vacuum.a10.js');
const IjaiVacuumV2 = require('./devices/ijai.vacuum.v2.js');
const RoborockVacuumS5e = require('./devices/roborock.vacuum.s5e.js');
const RoborockVacuumS5 = require('./devices/roborock.vacuum.s5.js');
const DreameVacuumMb1808 = require('./devices/dreame.vacuum.mb1808.js');
const ViomiVacuumV19 = require('./devices/viomi.vacuum.v19.js');
const RoborockVacuumA08 = require('./devices/roborock.vacuum.a08.js');
...
const allDevices = [DreameVacuumP2008, DreameVacuumMc1808, RoborockVacuumA15, RoborockVacuumA11,
  ...
  DreameVacuumP2029, DreameVacuumP2140, DreameVacuumP2157, ViomiVacuumV18,
  RoborockVacuumA29, RoidmiVacuumV60, RoborockVacuumA10, IjaiVacuumV2,
  RoborockVacuumS5e, RoborockVacuumS5, DreameVacuumMb1808, ViomiVacuumV19, RoborockVacuumA08
];
