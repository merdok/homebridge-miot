...
const robotCleanerDevices = [DreameVacuumP2008, DreameVacuumMC1808, RoborockVacuumA15, RoborockVacuumA11,
...
class RobotCleanerFactory {
  ...
  static getDeviceClassForModel(deviceModel) {
    ...
    deviceFactoryClass = robotCleanerDevices.find(device => device.getDeviceModel() === deviceModel);
