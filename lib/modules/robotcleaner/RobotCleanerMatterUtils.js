...
function selectMatterCleanModeAction(cleanMode, actions = {}) {
  return cleanMode === MATTER_RVC_CLEAN_MODES.MOP ? actions.startMop || null :
    cleanMode === MATTER_RVC_CLEAN_MODES.VACUUM_MOP ? actions.startSweepMop || null :
      actions.startOnlySweep || actions.startSweep || null;
}
