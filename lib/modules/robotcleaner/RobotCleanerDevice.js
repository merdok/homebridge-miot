...
class RobotCleanerDevice extends BaseDevice {
  ...
  statusWashValue() {
    return this.getValueForStatus('Wash');
  }
  statusEmptyingValue() {
    return this.getValueForStatus('Emptying');
  }
  ...
  isStatusSweeping() {
    return this._checkStatusValue(this.statusSweepingValue());
  }

  isStatusSweepingAndMopping() {
    return this._checkStatusValue(this.statusSweepingAndMoppingValue());
  }

  isStatusMopping() {
    return this._checkStatusValue(this.statusMoppingValue());
  }

  isStatusPause() {
    return this._checkStatusValue(this.statusPausedValue());
  }

  isStatusError() {
    return this._checkStatusValue(this.statusErrorValue());
  }

  isStatusGoCharging() {
    return this._checkStatusValue(this.statusGoChargingValue());
  }


  /*----------========== HELPERS ==========----------*/

  _checkStatusValue(value) {
    if (value != null) {
      let statusVal = this.getStatus();
      if (Array.isArray(value)) {
        return value.includes(statusVal);
      } else {
