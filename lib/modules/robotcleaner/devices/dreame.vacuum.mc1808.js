...
class DreameVacuumMC1808 extends RobotCleanerDevice {
  ...
  initDeviceActions() {
    this.addAction(RobotCleanerActions.START_SWEEP, 3, 1, []);
    this.addAction(RobotCleanerActions.STOP_SWEEP, 3, 2, []);
    this.addAction(RobotCleanerActions.START_CHARGE, 2, 1, []);
    this.addAction(RobotCleanerActions.RESET_BRUSH_LIFE, 26, 1, []);
    this.addAction(RobotCleanerActions.RESET_SIDE_BRUSH_LIFE, 28, 1, []);
    this.addAction(RobotCleanerActions.RESET_FILTER_LIFE, 27, 1, []);
    this.addAction(RobotCleanerActions.START_CLEAN, 18, 1, []);
    this.addAction(RobotCleanerActions.STOP_CLEAN, 18, 2, []);
    this.addAction(RobotCleanerActions.LOCATE_ROBOT, 24, 1, []);
    this.addAction(RobotCleanerActions.PLAY_SOUND, 24, 3, []);
  }
