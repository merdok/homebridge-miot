...
class DreameVacuumP2041 extends RobotCleanerDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(RobotCleanerProperties.MOP_MODE, 4, 5, PropFormat.INT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [1, 3, 1]);
  ...
  initDeviceActions() {
    ...
    this.addAction(Actions.START_CLEAN, 4, 1, [10]); // 1 parameter is not in the spec, from where comes the parameters?
