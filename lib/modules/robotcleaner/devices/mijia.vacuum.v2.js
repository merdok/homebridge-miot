...
class MijiaVacuumV2 extends RobotCleanerDevice {
  ...
  initDeviceProperties() {
    ...
    this.addProperty(Properties.TARGET_WATER_LEVEL, 2, 5, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 1,
        "description": "Level1"
      },
      {
    ...
    this.addProperty(Properties.FAN_LEVEL, 2, 6, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 0,
        "description": "Silence"
      },
      {
    ...
    this.addProperty(Properties.ALARM_VOLUME, 4, 2, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(Properties.DO_NOT_DISTURB, 12, 2, PropFormat.BOOL, PropAccess.READ_WRITE, PropUnit.NONE);
    ...
    this.addProperty(Properties.BRUSH_LEFT_TIME, 14, 2, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.DAYS, [0, 18000, 1]);
    this.addProperty(Properties.BRUSH_LIFE_LEVEL, 14, 1, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(Properties.SIDE_BRUSH_LEFT_TIME, 15, 2, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.MINUTES, [0, 9000, 1]);
    this.addProperty(Properties.SIDE_BRUSH_LIFE_LEVEL, 15, 1, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(Properties.FILTER_LIFE_LEVEL, 11, 1, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(Properties.FILTER_LEFT_TIME, 11, 2, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.MINUTES, [0, 18000, 1]);
    this.addProperty(Properties.WORK_MODE, 18, 1, PropFormat.INT32, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 17, 1]);
    this.addProperty(Properties.TOTAL_CLEAN_TIME, 9, 4, PropFormat.UINT32, PropAccess.READ_NOTIFY, PropUnit.MINUTES, [0, 4294967295, 1]);
    this.addProperty(Properties.TOTAL_CLEAN_TIMES, 9, 5, PropFormat.UINT16, PropAccess.READ_NOTIFY, PropUnit.NONE, [0, 65535, 1]);
    this.addProperty(Properties.TOTAL_CLEAN_AREA, 9, 3, PropFormat.UINT32, PropAccess.READ_NOTIFY, PropUnit.NONE, [0, 4294967295, 1]);
  }
