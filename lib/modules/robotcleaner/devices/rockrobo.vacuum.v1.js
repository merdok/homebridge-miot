...
class RoborockVacuumV1 extends RobotCleanerDevice {
  ...
  initDeviceProperties() {
    // READ/WRITE
    this.addProperty(Properties.SPEED_LEVEL, 2, 2, PropFormat.UINT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
...
module.exports = RoborockVacuumV1;
