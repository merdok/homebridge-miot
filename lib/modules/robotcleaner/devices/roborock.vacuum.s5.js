const RockroboVacuumV1 = require('./rockrobo.vacuum.v1.js');


// The S5 exposes a MIOT spec through MiCloud, but its LAN protocol is the same
// legacy miIO command set as the first-generation Rockrobo vacuum. Inheriting
// the local readers and Matter command fallbacks keeps cloud/HAP support while
// allowing the S5 to be paired as a native Matter robot.
class RoborockVacuumS5 extends RockroboVacuumV1 {
