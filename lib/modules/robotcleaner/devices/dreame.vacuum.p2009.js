...
class DreameVacuumP2009 extends RobotCleanerDevice {
  ...
  getDeviceMiotSpec() {
    return "http://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:vacuum:0000A006:dreame-p2009:2";
  }
  ...
  initDeviceProperties() {
    // READ/WRITE
    this.addProperty(Properties.MODE, 4, 4, PropFormat.INT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 0,
        "description": "Silent"
      },
      {
    ...
    this.addProperty(Properties.MOP_MODE, 4, 5, PropFormat.INT8, PropAccess.READ_WRITE_NOTIFY, PropUnit.NONE, [], [{
        "value": 1,
    ...
    this.addProperty(Properties.BRUSH_LEFT_TIME, 9, 1, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 300, 1]);
    this.addProperty(Properties.BRUSH_LIFE_LEVEL, 9, 2, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.PERCENTAGE, [0, 100, 1]);
    this.addProperty(Properties.SIDE_BRUSH_LEFT_TIME, 10, 1, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 200, 1]);
    ...
    this.addProperty(Properties.FILTER_LEFT_TIME, 11, 2, PropFormat.UINT8, PropAccess.READ_NOTIFY, PropUnit.HOURS, [0, 150, 1]);
  ...
  initDeviceActions() {
    ...
    this.addAction(Actions.START_CLEAN, 4, 1, [10]);
