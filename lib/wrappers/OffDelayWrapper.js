...
class OffDelayWrapper extends AbstractPropertyWrapper {
  ...
  handleBoolean() {
    ...
    this.offDelayBooleanService = new Service.Switch(this.sanitizeName(serviceName), serviceId);
    this.setServiceConfiguredName(this.offDelayBooleanService, serviceName);
  ...
  handleValueRange() {
    ...
    this.offDelayLightbulbService = new Service.Lightbulb(this.sanitizeName(serviceName), serviceId);
    this.setServiceConfiguredName(this.offDelayLightbulbService, serviceName);
