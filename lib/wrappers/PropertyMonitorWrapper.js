...
class PropertyMonitorWrapper extends AbstractPropertyWrapper {
  ...
  getOccupancyDetected() {
    if (this.isMiotDeviceConnected() && this.checkLinkedPropStatus()) {
      return this.isOccupancyTriggered() ? Characteristic.OccupancyDetected.OCCUPANCY_DETECTED : Characteristic.OccupancyDetected.OCCUPANCY_NOT_DETECTED;
    }
