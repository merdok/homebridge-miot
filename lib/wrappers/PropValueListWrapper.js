...
class PropValueListWrapper extends AbstractPropertyWrapper {
  ...
  createStatefulSwitch(switchName, switchId, itemVal) {
    ...
    tmpStatefulSwitch.addOptionalCharacteristic(Characteristic.ConfiguredName);
    tmpStatefulSwitch.setCharacteristic(Characteristic.ConfiguredName, switchName);
    tmpStatefulSwitch
  ...
  createStatlessSwitch(switchName, switchId, itemVal) {
    ...
    tmpStatlessSwitch.addOptionalCharacteristic(Characteristic.ConfiguredName);
    tmpStatlessSwitch.setCharacteristic(Characteristic.ConfiguredName, switchName);
    tmpStatlessSwitch
      .getCharacteristic(Characteristic.On)
      .onGet(() => {
