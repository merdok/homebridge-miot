...
class AngleButtonsWrapper extends AbstractPropertyWrapper {
  ...
  prepareWrapper() {
    ...
    if (this.swingAnglesList && this.swingAnglesList.length > 0) {
      ...
      this.swingAnglesList.forEach((swingAngle, i) => {
        ...
        tmpSwingAngleSwitch.addOptionalCharacteristic(Characteristic.ConfiguredName);
        tmpSwingAngleSwitch.setCharacteristic(Characteristic.ConfiguredName, switchName);
        tmpSwingAngleSwitch
