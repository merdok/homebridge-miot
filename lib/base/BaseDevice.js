...
class BaseDevice extends MiotDevice {
  ...
  // screen
  supportsSimpleScreenControl() {
    return this.hasProperty(Properties.SCREEN);
  }
  ...
  supportsScreenControl() {
    return this.supportsSimpleScreenControl() || this.supportsScreenBrightnessControl();
  }
  ...
  async setScreenEnabled(enabled) {
    this.setPropertyValue(Properties.SCREEN, enabled);
  }
