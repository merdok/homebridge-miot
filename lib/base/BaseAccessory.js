      ...
      if (prop) {
        ...
        if (newWrapper) {
          if (newWrapper.isWrapperValid()) {
            ...
            this.logger.warn(`Cannot add ${wrapperName} wrapper! Unknown property type!`);
          }
        } else {
      ...
      if (miotService) {
        ...
        if (newCustService) {
          if (newCustService.isServiceValid()) {
            ...
            this.logger.warn(`Cannot add ${serviceName || serviceId} custom service! Unknown service type!`);
          }
        } else {
