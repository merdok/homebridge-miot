...
class BaseAccessory extends AbstractAccessory {
  ...
  setupAdditionalAccessoryServices() {
    ...
    this.prepareAmbientLightService();
  ...
  prepareTemperatureService(customName) {
    if (this.getDevice().supportsTemperatureReporting() && !this.temperatureService) {
      ...
      this.temperatureService = new Service.TemperatureSensor(this.sanitizeName(serviceName), 'temperatureService');
      this.setServiceConfiguredName(this.temperatureService, serviceName);
  ...
  prepareRelativeHumidityService(customName) {
    if (this.getDevice().supportsRelativeHumidityReporting() && !this.relativeHumidityService) {
      ...
      this.relativeHumidityService = new Service.HumiditySensor(this.sanitizeName(serviceName), 'relativeHumidityService');
      this.setServiceConfiguredName(this.relativeHumidityService, serviceName);
  ...
  prepareIlluminationService(customName) {
    if (this.getDevice().supportsIlluminationReporting() && !this.illuminationService) {
      ...
      this.illuminationService = new Service.LightSensor(this.sanitizeName(serviceName), 'illuminationService');
      this.setServiceConfiguredName(this.illuminationService, serviceName);
  ...
  prepareBatteryService(customName) {
    if ((this.getDevice().supportsBatteryLevelReporting() || this.getDevice().supportsChargingReporting()) && !this.batteryService) {
      ...
      this.batteryService = new Service.Battery(this.sanitizeName(serviceName), 'batteryService');
      this.setServiceConfiguredName(this.batteryService, serviceName);
      this.batteryService
        .getCharacteristic(Characteristic.StatusLowBattery)
        .onGet(this.getStatusLowBatteryState.bind(this));
  ...
  prepareFilterMaintenanceService(customName) {
    if (this.getDevice().supportsFilterLifeLevelReporting() && !this.filterMaintenanceService) {
      ...
      this.filterMaintenanceService = new Service.FilterMaintenance(this.sanitizeName(serviceName), 'filterMaintenanceService');
      this.setServiceConfiguredName(this.filterMaintenanceService, serviceName);
  ...
  prepareAirQualityService(pm25Breakpoints) {
    if (this.getDevice().supportsPm25DensityReporting() && !this.airQualityService) {
      ...
      this.setServiceConfiguredName(this.airQualityService, 'Air Quality');
  ...
  prepareCarbonDioxideService(co2AbnormalThreshold) {
    if (this.getDevice().supportsCo2DensityReporting() && !this.carbonDioxideService) {
      ...
      this.setServiceConfiguredName(this.carbonDioxideService, 'Carbon Dioxide');
  ...
  prepareAmbientLightService() {
    if (this.getDevice().hasAmbientLightService()) {
      this.addLightService('ambientLightService', "Ambient Light", this.getDevice().getAmbientLightService());
    }
  }
  ...
  getFilterLifeLevel() {
    if (this.isMiotDeviceConnected()) {
      let safeLifeLevel = Math.min(100, this.getDevice().getFilterLifeLevel()); // some device return a value greater than 100
      return safeLifeLevel;
    }
    return 0;
  }
  ...
  updateAccessoryStatus() {
    if (this.temperatureService) {
      ...
      if (this.getDevice().supportsBatteryLevelReporting()) this.temperatureService.getCharacteristic(Characteristic.StatusLowBattery).updateValue(this.getStatusLowBatteryState());
    }
    ...
    if (this.relativeHumidityService) {
      ...
      if (this.getDevice().supportsBatteryLevelReporting()) this.relativeHumidityService.getCharacteristic(Characteristic.StatusLowBattery).updateValue(this.getStatusLowBatteryState());
    }
    ...
    if (this.illuminationService) {
      ...
      if (this.getDevice().supportsBatteryLevelReporting()) this.illuminationService.getCharacteristic(Characteristic.StatusLowBattery).updateValue(this.getStatusLowBatteryState());
    }
    ...
    if (this.airQualityService) {
      if (this.getDevice().supportsBatteryLevelReporting()) this.airQualityService.getCharacteristic(Characteristic.StatusLowBattery).updateValue(this.getStatusLowBatteryState());
    ...
    if (this.carbonDioxideService) {
      if (this.getDevice().supportsBatteryLevelReporting()) this.carbonDioxideService.getCharacteristic(Characteristic.StatusLowBattery).updateValue(this.getStatusLowBatteryState());
