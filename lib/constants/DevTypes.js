...
ALL_DEVICES.OCCUPANCY_SENSOR = {
  'type': 'OccupancySensor',
  'specTypes': ['Occupancy Sensor', 'occupancy-sensor']
}

ALL_DEVICES.DIFFUSER = {
  'type': 'Diffuser',
  'specTypes': ['Diffuser', 'diffuser']
}
...
module.exports.OCCUPANCY_SENSOR = ALL_DEVICES.OCCUPANCY_SENSOR.type;
module.exports.DIFFUSER = ALL_DEVICES.DIFFUSER.type;
