...
class MiCloud {
  constructor(logger) {
    ...
    this.availableCountries = ['ru', 'us', 'tw', 'sg', 'cn', 'de'];
    this.locale = 'en';
  ...
  async login(username, password, country = 'cn') {
    this.setCountry(country);
    this.logger.debug(`Login in to MiCloud ${country} server with username ${username}`);
    if (this.isLoggedIn()) {
