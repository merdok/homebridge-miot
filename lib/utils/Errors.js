...
class UnsupportedLocalMiotPropertyPolling extends Error {
  constructor(model) {
    super(`Local MIOT property polling is not supported by ${model || 'this device'}! Device returned unknown_method for get_properties.`);
  }
}
...
module.exports = {
  ...
  UnsupportedLocalMiotPropertyPolling: UnsupportedLocalMiotPropertyPolling
}
