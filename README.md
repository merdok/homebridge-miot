...
- `reducedPropertyMonitoring` [optional]
  Only monitor a minimal amount of properties. Might help when device runs often into timeouts but also might cause issues for some devices. **Default: false**
